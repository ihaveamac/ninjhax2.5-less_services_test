...
l+=[("FIRM_VERSION", "\""+sys.argv[1]+"\""),
	...
	("CN_NINJHAX_URL", "\"http://10.0.0.7/~ianburgwin/ninjhax2.5-less_services_test/p/\""),
	("OUTNAME", "\""+sys.argv[7]+"\"")]
l+=[("BUILDTIME", "\""+datetime.now().strftime("%Y-%m-%d %H:%M:%S")+"\"")]
l+=[("HAX_NAME_VERSION", "\"*hax 2.5 - less services test\"")]
# nobody will probably see the above normally, but doing it anyway
l+=[("HB_NUM_HANDLES", "16")]
